...
INSERT INTO "new_user_preferences" ("accentColor", "colorMode", "columnRenderOverrides", "connectionOverrides", "customPalettes", "fontSize", "gridDensity", "keybindings", "userId") SELECT "accentColor", "colorMode", "columnRenderOverrides", "connectionOverrides", "customPalettes", "fontSize", "gridDensity", "keybindings", "userId" FROM "user_preferences";
